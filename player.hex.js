...
const trackname = hexsrc.getAttribute("name");
const trackartist = hexsrc.getAttribute("artist");
...
hextext.style.width = 'calc(100% - 460px)';
hextext.style.right = '0'
hextext.zIndex = '2';
hextext.style.marginLeft = '460px';
document.getElementById('trackslit').style.marginBottom = '65px';
document.getElementById('playslit').style.marginBottom = '0px';
}
}
